<header class="">
        <div class="container" style="margin-top: 10px;">
          <a class="navbar-brand" href="#" style="font-size: 25px;">ACCEE Logo</a>
            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav ">
                  <li class="{{ set_active('/') }}"><a href="{{ url('/') }}">首页 <span class="sr-only">(current)</span></a></li>
                  <li class="{{ set_active('about/*') }} {{ set_active('about') }}"><a href="{{ url('/about') }}">关于商会</a></li>
                  <li class="dropdown {{ set_active('sk/*') }}" >
                  ...
                  <li class="dropdown {{ set_active('activity/*') }}">
                  ...
                  <li class="dropdown {{ set_active('membership/*') }}">
                  ...
                  <li class="dropdown {{ set_active('investment/*') }}">
                  ...
                  <li class="{{ set_active('gallery')}} {{ set_active('gallery/*')}}"><a href="{{ url('/gallery') }}">图片视频</a></li>
                  <li class="{{ set_active('contact') }}"><a href="{{ url('/contact') }}">联系我们</a></li>
                </ul>
