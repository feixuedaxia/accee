						...
						<div class="col-md-12">
							...
							{{ method_field('PATCH') }}
								...
								<div class="form-group">
									...
									<button class="btn btn-default" type="submit" v-if="edit">Add New Category</button>

									<button class="btn btn-default" type="submit" v-if="edit" @click="EditPost(newPost.id)">Update</button>
								</div>
